...
echo_and_run cd "/home/allen12/autorace_workshop/src/turtlebot3/turtlebot3_teleop"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/allen12/autorace_workshop/src/turtlebot3/turtlebot3_teleop/setup.py" \
     \
    build --build-base "/home/allen12/autorace_workshop/build/turtlebot3/turtlebot3_teleop" \
    install \
    --root="${DESTDIR-/}" \
