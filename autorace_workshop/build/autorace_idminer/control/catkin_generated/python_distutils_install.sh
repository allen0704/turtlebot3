...
echo_and_run cd "/home/allen12/autorace_workshop/src/autorace_idminer/control"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/allen12/autorace_workshop/src/autorace_idminer/control/setup.py" \
     \
    build --build-base "/home/allen12/autorace_workshop/build/autorace_idminer/control" \
    install \
    --root="${DESTDIR-/}" \
