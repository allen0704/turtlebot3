...
if("TRUE" STREQUAL "TRUE")
  set(detect_SOURCE_PREFIX /home/allen12/autorace_workshop/src/autorace_idminer/detect)
  set(detect_DEVEL_PREFIX /home/allen12/autorace_workshop/devel)
  set(detect_INSTALL_PREFIX "")
  set(detect_PREFIX ${detect_DEVEL_PREFIX})
else()
  set(detect_SOURCE_PREFIX "")
  set(detect_DEVEL_PREFIX "")
  set(detect_INSTALL_PREFIX /home/allen12/autorace_workshop/install)
...
if(NOT "/home/allen12/autorace_workshop/devel/include " STREQUAL " ")
  set(detect_INCLUDE_DIRS "")
  set(_include_dirs "/home/allen12/autorace_workshop/devel/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'zhl017 <zhl017@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'detect' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/allen12/autorace_workshop/src/autorace_idminer/detect/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/allen12/autorace_workshop/devel/lib;/home/allen12/catkin_ws/devel/lib;/opt/ros/noetic/lib)
...
set(detect_EXPORTED_TARGETS "detect_gencfg")
